...
# ---------------- to print the sum of the craters' squared radii for each hemisphere -----
print("This is the sums of the craters' squared radii for each hemisphere. I-st column is the abbreviation of a hemisphere; II-nd - the indicated sum.")
new_data["SQUARE_RADIUS"] = ((new_data["DIAM_CIRCLE_IMAGE"]/2)**2).round(2)
print(new_data.groupby(by=["HEMISPH"])['SQUARE_RADIUS'].sum())
new_data = new_data[["HEMISPH", "LATITUDE_CIRCLE_IMAGE", "LONGITUDE_CIRCLE_IMAGE", "SQUARE_RADIUS"]]
